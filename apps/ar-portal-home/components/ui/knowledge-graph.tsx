	...
	(
		...
		return (
			<div className={cn("relative h-full w-full min-h-[400px]", className)}>
				...
				{tooltip.visible && (
					<div
						className="pointer-events-none absolute z-10 px-3 py-2 text-sm rounded-lg bg-zinc-900 text-zinc-100 shadow-lg border border-zinc-700 dark:bg-zinc-800"
				...
				{showLegend && legendItems.length > 0 && (
					<div className="absolute top-4 right-4 z-10 p-3 rounded-lg bg-white/90 backdrop-blur-sm border border-zinc-200 shadow-sm dark:bg-zinc-800/90 dark:border-zinc-700">
